...
HUNTARA enforces strict security and privacy standards, keeping outbound prospecting data isolated, encrypted on disk, and protected from external networks.
...
If you discover a security vulnerability in HUNTARA, please report it:

1. **Contact**: Do not open a public GitHub issue. Send details to `security@huntara.app`.
